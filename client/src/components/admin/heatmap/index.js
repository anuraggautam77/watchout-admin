        ...
        var template = this.state.cratlist.map((option, i) => {
            return (
                    <li className={`list-group-item`} key={i}>
                        ...
                        <b> {option.fno} <sup>th</sup>  Floor  </b> 
                                                                    ...
                                                                    return (
                                                                                    ...
                                                                                    return (
                                                                                                                                                                ...
                                                                                                                                                                setcartloc={(blockid, lid) => {
                                                                                                                                                                        this.setState({...this.state, location: blockid, lid: lid})}} />
                                                                                            );
                                                                                }
                                                                                })()}
                                                                            </div>
                                                                                                                                                                        ...
                                                                                                                                                                        <div className="panel panel-default">
                                                                                                                                                                            ...
                                                                                                                                                                            <div className="panel-body">
                                                                                                                                                                                <div className="form-group">
                                                                                                                                                                                    <b> { `${this.state.floorno} Floor `} { this.state.location }   </b>
                                                                                                                                                                                </div>
                                                                                                                                        
                                                                                                                                                                                <div className="form-group">
                                                                                                                                                                                    <label htmlFor="restore-email"><b>Cart Number</b></label>
                                                                                                                                                                                    <input className="form-control" type="text" size="20" ref="cartno"  minLength="9" maxLength="10"  placeholder="Cart No!"/>
                                                                                                                                                                                </div>
                                                                                                                                                                                <div className="form-group">
                                                                                                                                                                                    <input type="button" onClick={() => {
                                                                                                                                                                                this.placeCartHandler()
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            }} className="btn btn-primary" value ="Place cart" />
                                                                                                                                                                                </div>
                                                                                                                                                                            </div>
                                                                                                                                                                        </div>
                                                                                                                )
